...
{
    /**
     * @var \Ecentura\Orderattachment\Helper\Upload
     */
    ...
    /**
     * @var \Ecentura\Orderattachment\Model\AttachmentFactory
     */
     ...
     * @param \Ecentura\Orderattachment\Helper\Upload $uploadModel
     * @param \Magento\Store\Model\StoreManagerInterface $storeManager
     * @param \Magento\Checkout\Model\Session $checkoutSession
     * @param \Magento\Framework\Math\Random $random
     * @param \Magento\Framework\Stdlib\DateTime\DateTime $dateTime
     * @param \Ecentura\Orderattachment\Model\AttachmentFactory $attachmentFactory
    ...
    public function __construct(
        ...
        \Ecentura\Orderattachment\Helper\Upload $uploadModel,
        \Magento\Store\Model\StoreManagerInterface $storeManager,
        \Magento\Checkout\Model\Session $checkoutSession,
        \Magento\Framework\Math\Random $random,
        \Magento\Framework\Stdlib\DateTime\DateTime $dateTime,
        \Ecentura\Orderattachment\Model\AttachmentFactory $attachmentFactory,
    ...
    public function saveAttachment($request)
    {
        try {
            ...
            $result['hash_class'] = 'ecentura-attachment-hash'.$attachment->getId();
            $result['attachment_class'] = 'ecentura-attachment-id'.$attachment->getId();
            $result['comment'] = '';
        } catch (\Exception $e) {
            $result = [
                'success' => false,
        ...
        if (count($attachments) > 0) {
            foreach ($attachments as &$attachment) {
                ...
                if ($byOrder) {
                    ...
                    $attachment['attachment_class'] = 'ecentura-attachment-id'.$attachment['attachment_id'];
                    $attachment['hash_class'] = 'ecentura-attachment-hash'.$attachment['attachment_id'] ;
                }
            }
