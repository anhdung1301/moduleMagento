...
namespace Ecentura\Orderattachment\Block\Checkout;
...
use Ecentura\Orderattachment\Helper\Data;
    ...
    public function process($jsLayout)
    {
     ...
     protected function addToAfterPaymentMethods(&$jsLayout)
     {
        if (isset($jsLayout['components']['checkout']['children']['steps']['children']['billing-step']
            ...
            $fields['order-attachment-after-payment-methods'] = ['component' => "Ecentura_Orderattachment/js/view/order/payment/payment-attachment"];
        }
     ...
     protected function addToAfterShippingAddress(&$jsLayout)
     {
         if (isset($jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']
            ...
            $fields['order-attachment-after-shipment-address'] =
                [
                    'component' => "Ecentura_Orderattachment/js/view/order/shipment/shipment-attachment"
                ];
        }
           ...
           if (isset($jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']
                ...
                $fields['order-attachment-after-shipment-methods'] =
                    [
                        ...
                        'children' =>  ['attachment'=> ['component' => "Ecentura_Orderattachment/js/view/order/shipment/shipment-attachment"]]
                    ];
          }
