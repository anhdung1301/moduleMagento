<?php
namespace Ecentura\Orderattachment\Model;
...
class AttachmentConfigProvider implements ConfigProviderInterface
{
    ...
    /**
     * @var \Ecentura\Orderattachment\Helper\Data
     */
     ...
     * @param \Ecentura\Orderattachment\Model\ResourceModel\Attachment\Collection $attachmentCollection
    ...
    public function getConfig()
    {
        ...
        return [
            'ecenturaAttachmentEnabled'  => $this->isOrderAttachmentEnabled(),
            'attachments'          => $uploadedAttachments['result'],
            'ecenturaAttachmentLimit'    => $this->getOrderAttachmentFileLimit(),
            'ecenturaAttachmentSize'     => $this->getOrderAttachmentFileSize(),
            'ecenturaAttachmentExt'      => $this->getOrderAttachmentFileExt(),
            'ecenturaAttachmentUpload'   => $this->getAttachmentUploadUrl(),
            'ecenturaAttachmentUpdate'   => $this->getAttachmentUpdateUrl(),
            'ecenturaAttachmentRemove'   => $this->getAttachmentRemoveUrl(),
            ...
            'ecenturaAttachmentTitle' =>  $this->dataHelper->getTitle(),
    ...
    private function getUploadedAttachments()
    {
        if ($quoteId = $this->checkoutSession->getQuote()->getId()) {
            ...
            foreach ($result['items'] as $key => $value) {
                $result['items'][$key]['attachment_class'] = 'ecentura-attachment-id'.$value['attachment_id'];
                $result['items'][$key]['hash_class'] = 'ecentura-attachment-hash'.$value['attachment_id'] ;
            }
