...
use Ecentura\Orderattachment\Api\Data;
use Ecentura\Orderattachment\Api\AttachmentRepositoryInterface;
...
use Ecentura\Orderattachment\Model\ResourceModel\Attachment as ResourceAttachment;
use Ecentura\Orderattachment\Model\ResourceModel\Attachment\CollectionFactory as AttachmentCollectionFactory;
...
class AttachmentRepository implements AttachmentRepositoryInterface
{
    ...
    public function __construct(
        ...
        \Ecentura\Orderattachment\Api\Data\AttachmentInterfaceFactory $dataAttachmentFactory,
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $criteria)
    {
        ...
        foreach ($collection as $blockModel) {
            ...
            $this->dataObjectHelper->populateWithArray(
                $blockData,
                $blockModel->getData(),
                'Ecentura\Orderattachment\Api\Data\AttachmentInterface'
            );
