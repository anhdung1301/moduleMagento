define(
    ...
    function ($, ko, Component) {
        ...
        return Component.extend({
            defaults: {
                template: 'Ecentura_Orderattachment/attachment-markup'
            },
            ...
            initialize: function () {
                ...
                this.allowedExtensions = this.attachementData.ecenturaAttachmentExt;
                this.maxFileSize = this.attachementData.ecenturaAttachmentSize;
                this.removeItem = this.attachementData.removeItem;
                this.maxFileLimit = this.attachementData.ecenturaAttachmentLimit;
                this.invalidExtError = this.attachementData.ecenturaAttachmentInvalidExt;
                this.invalidSizeError = this.attachementData.ecenturaAttachmentInvalidSize;
                this.invalidLimitError = this.attachementData.ecenturaAttachmentInvalidLimit;
                this.uploadUrl = this.attachementData.ecenturaAttachmentUpload;
                this.updateUrl = this.attachementData.ecenturaAttachmentUpdate;
                this.removeUrl = this.attachementData.ecenturaAttachmentRemove;
                this.comment = this.attachementData.ecenturaAttachmentComment;
                this.attachments = this.attachementData.attachments;
                this.attachmentTitle = this.attachementData.ecenturaAttachmentTitle;
                this.attachmentInfromation = this.attachementData.ecenturaAttachmentInfromation;
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (result.success) {
                            ...
                            $('div.ecentura-attachment-row[rel="' + hash + '"]').remove();
                        }
                        self.hideRowLoader();
                    },
                    error: function(xhr, ajaxOptions, thrownError) {
