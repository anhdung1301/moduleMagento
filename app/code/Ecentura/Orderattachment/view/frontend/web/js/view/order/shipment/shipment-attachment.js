define(
    ...
    function ($, ko, Component) {
        ...
        return Component.extend({
            defaults: {
                template: 'Ecentura_Orderattachment/order/shipment/attachment-markup'
            },
            attachmentList: ko.observableArray([]),
            isVisible: window.checkoutConfig.ecenturaAttachmentEnabled,
            ...
            initialize: function () {
                ...
                this.allowedExtensions = window.checkoutConfig.ecenturaAttachmentExt;
                this.maxFileSize = window.checkoutConfig.ecenturaAttachmentSize;
                this.removeItem = window.checkoutConfig.removeItem;
                this.maxFileLimit = window.checkoutConfig.ecenturaAttachmentLimit;
                this.invalidExtError = window.checkoutConfig.ecenturaAttachmentInvalidExt;
                this.invalidSizeError = window.checkoutConfig.ecenturaAttachmentInvalidSize;
                this.invalidLimitError = window.checkoutConfig.ecenturaAttachmentInvalidLimit;
                this.uploadUrl = window.checkoutConfig.ecenturaAttachmentUpload;
                this.updateUrl = window.checkoutConfig.ecenturaAttachmentUpdate;
                this.removeUrl = window.checkoutConfig.ecenturaAttachmentRemove;
                this.comment = window.checkoutConfig.ecenturaAttachmentComment;
                this.attachments = window.checkoutConfig.attachments;
                this.attachmentTitle = window.checkoutConfig.ecenturaAttachmentTitle;
                this.attachmentInfromation = window.checkoutConfig.ecenturaAttachmentInfromation;
