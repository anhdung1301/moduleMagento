...
class InstallData implements InstallDataInterface
{
    ...
    {
        $content = '<div class="content-below" >
    <div class="container">
        ...
        $cmsBlockData = [
            ...
            'content' => '<p>{{block class="Ecentura\LandingPage\Block\Landing\Custom"  name ="landing-page" template="Ecentura_LandingPage::custom.phtml"}} </p>'.$content,
            'is_active' => 1,
            'stores' => [0],
            'sort_order' => 0
        ];
